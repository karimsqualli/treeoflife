...
namespace VinceToolbox.TriangulateEarClipping
{
    /// <summary>
    ...
    public class CPolygon
    {
        ...
        //-----------------------------------------------------------------------------------------
        public CPolygon(CPoint2D[] _points)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    for (int i = 0; i < numPoints; i++) m_aVertices[i] = _points[i];
                }
            }
            catch (Exception e)
            {
        ...
        public CPolygon(CPoint2D[] _points, int[] _index)
        {
            ...
            try
            {
                ...
                {
                    m_aVertices = new CPoint2D[numPoints];
                    for (int i = 0; i < numPoints; i++) m_aVertices[i] = _points[_index[i]];
                }
            }
            catch (Exception e)
            {
        ...
        *****************************************/
        ...
        public static void ReversePointsDirection( CPoint2D[] points )
        {
            ...
            CPoint2D[] aTempPts=new CPoint2D[nVertices];
            for (int i=0; i<nVertices; i++) aTempPts[i]=points[i];
            for (int i=0; i<nVertices; i++) points[i]=aTempPts[nVertices-1-i];	
        }

        //-----------------------------------------------------------------------------------------
        public static void ReversePointsIndexDirection(int[] pointsIndex)
        {
            int nVertices = pointsIndex.Length;
            int[] aTempPts = new int[nVertices];
            for (int i = 0; i < nVertices; i++) aTempPts[i] = pointsIndex[i];
            for (int i = 0; i < nVertices; i++) pointsIndex[i] = aTempPts[nVertices - 1 - i];
        }
